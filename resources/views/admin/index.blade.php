...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <p class="navbar-brand" style="margin-bottom: 0;">ECサイト ｜ 管理画面TOP</p>

  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link btn btn-link" href="{{ route('items') }}">商品管理</a>
      </li>
      <li class="nav-item">
      ...
      <div class="card mx-auto">
        ...
        <div class="card-body">
          ...
          <table class="table table-sm">
            ...
            <tr>
              <td>
                <td> </td><td><strong>総合計</strong></td><td>{{ $sum }}円</td>
              </td>
            </tr>
          </table>
          {{ $sells->links() }}
